...
#[no_mangle]
pub unsafe extern "C" fn ecall_ecc_key_create(op_index: *mut usize) -> sgx_status_t {
...
#[no_mangle]
pub unsafe extern "C" fn ecall_ecc_sign(data: *const u8, data_len: usize) -> sgx_status_t {
...
extern "C" {
    ...
    fn EC_KEY_asn1_get_private_key(key: *const EcKey, priv_key: *mut *mut c_uchar) -> size_t;
